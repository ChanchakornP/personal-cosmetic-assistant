...
class RecommendationEngine:
    ...
    def get_recommendations(
        ...
        # Try LLM-generated explanations with chain-of-thought thinking
        if self.llm_service.is_available() and top_products:
            ...
            # Generate batch explanations using LangChain with thinking
            batch_explanations = (
                self.llm_service.generate_batch_recommendation_explanations(
